...
namespace DatingApp.API.Controllers
{
    ...
    public class PhotoController : ControllerBase
    {
        ...
        {
            var photoFromRepo = await _repo.GetPhotoForUser(id);
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id)
        {
            ...
            if (photoFromRepo == null) return Unauthorized();
            if (photoFromRepo.IsMain) return BadRequest("This is already the Main photo");

            var mainPhotoFromRepo = userFromRepo.Photos.FirstOrDefault(p => p.IsMain == true);
        ...
        public async Task<IActionResult> DeletePhoto(int userId, int id)
        {
            ...
            if (photoFromRepo.IsMain) return BadRequest("Can not delete main photo");
